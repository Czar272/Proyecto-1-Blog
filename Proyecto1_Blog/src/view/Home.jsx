                    ...
                    {data.map(item => (
                        <div className="card">
                            <div className="cardCol1">
                                <div className="titlesqr"> <h1 className='title'>{item.title}</h1> </div> 
                                <div className="descriptionsqr"> <h3 className='description'>{item.description}</h3></div>
                            </div>
